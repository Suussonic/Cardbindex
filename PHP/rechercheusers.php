...
<head>
    ...
    <link rel="stylesheet" href="../recherche/recherche.css">
...
<body>
    ...
    <form>
        <div class="form-row align-items-center">
            <div class="col-auto">
                <label class="sr-only" for="search">Utilisateur</label>
                <input type="text" class="form-control mb-2" id="search">
            </div>
            <div class="col-auto">
                <button type="submit" class="btn btn-primary mb-2" id="submit-button">Rechercher</button>
            </div>
        </div>
    </form>
